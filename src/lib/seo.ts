...
export const localServiceKeywords = [
  ...
  "Deploiement de materiel informatique",
  "Installation reseau",
  "Installation Wi-Fi",
  "Cablage reseau",
  "Sauvegarde de donnees",
  "Intervention informatique sur site",
  "Support utilisateurs",
  "Maintenance parc informatique",
  "Accompagnement informatique",
  "Service informatique de proximite",
  "Infogerance de proximite",
  "Assistance informatique sur site",
  "Optimisation poste de travail",
...
export const defaultSEO: Metadata = {
  ...
  keywords: [
    ...
    "installation poste informatique Strasbourg",
  ...
  icons: {
    icon: [
      ...
      { url: "/images/favicon/9.png", type: "image/png", sizes: "512x512" },
    ],
    apple: [{ url: "/images/favicon/9.png", type: "image/png", sizes: "512x512" }],
    shortcut: ["/images/favicon/10.png"],
  },
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: `${siteName} - installation, assistance et maintenance informatique sur site`,
      },
    ],
  },
  twitter: {
